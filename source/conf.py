...
copyright = u'2012-2016, Cris Ewing'
...
html_title = "Internet Programming with Python"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "UWPCE Python 200"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "_static/logo_UW.png"
...
htmlhelp_basename = 'InternetProgrammingwithPython'
...
latex_documents = [
  ('index', 'InternetProgrammingwithPython.tex', u'Internet Programming with Python',
   u'Cris Ewing', 'manual'),
]
...
man_pages = [
    ('index', 'internetprogrammingwithpython', u'Internet Programming with Python',
     [u'Cris Ewing'], 1)
]
...
epub_copyright = u'2012-2015, Cris Ewing'
